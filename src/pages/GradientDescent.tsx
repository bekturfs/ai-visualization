  ...
  return (
    <Layout crumb="03 · Градиентный спуск" crumbEn="gradient descent">
      ...
      <p className="mb-4 max-w-[920px] text-muted">
        Высота ландшафта — ошибка сети L(w1, w2). Обучение — повтор одного
        правила: <code className="font-mono">w ← w − η·∇L</code>. Сцену можно
        вращать (зажми мышь), приближать (колесо) и кликать, чтобы поставить
        шарик.
      </p>
