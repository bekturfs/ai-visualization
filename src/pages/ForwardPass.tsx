  ...
  return (
    <Layout crumb="02 · Forward pass" crumbEn="прямой проход через сеть">
      ...
      <p className="mb-4 max-w-[900px] text-muted">
        <b className="text-ink">Слой отвечает за несколько разных «взглядов»</b>{" "}
        на одни и те же данные (каждый нейрон замечает своё),{" "}
        <b className="text-ink">а сеть целиком — за сборку</b> этих
        микро-решений в большое. Здесь сеть 2–3–2: входной, скрытый и выходной
        слои; каждый нейрон считает σ(w·x + b) от выходов предыдущего слоя.
      </p>
