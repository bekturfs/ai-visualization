          ...
          {st === null && (
            <Card title="Что здесь происходит">
              <p className="my-2 max-w-[1000px] text-soft">
                ...
                линии. У sigmoid и tanh края «насыщаются» — кривая там почти
                плоская, и в этих зонах нейрон почти перестаёт реагировать на
                изменения (почему это мешает обучению — увидишь на странице 03).
                ReLU просто обрезает отрицательные z, а step — перцептрон 1958
                года, самый первый искусственный нейрон: только «да» или «нет».
              </p>
